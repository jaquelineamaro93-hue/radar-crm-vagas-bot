...
KEYWORDS = {
    ...
    "crm": [
        ...
        "crm",
        "aprendiz crm", "estagiário crm", "estagiario crm", "estágio crm", "estagio crm",
        "assistente de crm", "assistente crm",
        "analista de crm", "analista crm", "analista sistemas crm",
        "analista de crm jr", "analista de crm junior", "analista de crm pleno", "analista de crm senior", "analista de crm sênior",
        ...
        "gerente de crm", "gerente crm", "gerente de relacionamento crm",
        "gestor de crm", "gestor crm",
        "diretor de crm", "diretor crm", "diretora de crm",
        "head de crm", "head crm", "head of crm", "vp de crm",
        "consultor de crm", "consultor crm", "consultora de crm",
        "crm analyst", "crm manager", "crm specialist", "crm coordinator",
        "crm strategist", "crm director", "crm lead", "crm consultant",
        "crm executive", "crm supervisor",
        # CRM MARKETING / RELACIONAMENTO
        "crm marketing", "analista de crm marketing", "marketing de crm",
        "marketing de relacionamento", "analista de relacionamento crm",
        ...
        "jornada do consumidor crm", "mapeamento de jornada",
        "automacao de crm", "automação de crm",
        "lifecycle marketing", "email marketing crm",
        "marketing automation crm",
        # CRM ANALYTICS / DADOS
        "analytics crm", "crm analytics", "dados de crm",
        "analise de crm", "análise de crm",
        "analista de campanhas", "analista de campanha",
        "analista de canais digitais", "analista canais digitais",
        "growth crm", "crm growth",
        # CRM FUNCIONAL / IMPLEMENTAÇÃO
        "analista funcional crm", "consultor funcional crm", "funcional crm",
        "implementacao crm", "implementação crm", "implantacao crm", "implantação crm",
        "crm implementation", "crm onboarding",
        # CRM DEV / TÉCNICO
        "desenvolvedor crm", "dev crm", "crm developer",
        "engenheiro crm", "arquiteto crm", "crm architect", "crm engineer",
        "integração crm", "integracoes crm",
        # AUTOMAÇÃO DE MARKETING
        "automacao de marketing", "automação de marketing", "marketing automation",
        # SALESFORCE — todos os níveis
        "salesforce",
        "estagiário salesforce", "estagiario salesforce",
        "assistente salesforce", "analista salesforce", "analista de salesforce",
        ...
        "zendesk crm", "freshdesk crm", "intercom crm",
        # ÁREAS CORRELATAS
        "loyalty crm", "fidelização crm", "programa de fidelidade crm",
        "retenção de clientes crm", "retencao de clientes crm",
        "customer data platform", "cdp crm",
        "martech crm", "segmentacao crm", "segmentação crm",
        "personalização crm", "personalizacao crm",
    ],
    "data": [
        # Analista de dados

...
DISCORD_WEBHOOK_  = _env("DISCORD_WEBHOOK_CRM")
...
KEYWORDS = {
    ...
    "crm": [
        ...
        "especialista em e inteligencia artificial",
        "ai lifecycle marketing",
        "preditivo",
        "predictive specialist",
        "ai-driven growth specialist",
        "analista de dados de machine learning",
        ...
        "analista de jr", "analista de junior", "analista de pleno",
        "analista de senior", "analista de sênior",
        ...
        "gerente de crm", "gerente crm", "manager",
        ...
        "strategist", "director", "lead", "consultant",
        "executive", "supervisor", "product owner",
        ...
        "email marketing manager",
        "growth crm", "growth", "growth specialist",
        "especialista de growth", "especialista de growth e lifecycle",
        "growth marketing manager", "growth marketing specialist",
        "ltv specialist", "ltv manager", "e ltv",
        "product growth analyst", "analista de data",
        ...
        "especialista em e inteligencia artificial",
        "especialista em e inteligência artificial",
        "ai lifecycle marketing", "preditivo", "predictive crm",
        ...
        "ai agent architect",
        "ai agent product manager",
        "ai agent product specialist revops",
        ...
        "ai solutions architect cx automation",
        "ai-driven growth specialist",
        "analista automacao atendimento ia generativa",
        "analista dados machine learning",
        ...
        "engenheiro integracao agentes salesforce hubspot",
        ...
        "pm agentes ia",
        "predictive specialist",
        "prompt engineer jornadas cx vendas",
        ...
        "consultor tecnico implantacao ia crm",
        "engenheiro solucoes ia conversacional jornadas",
        "engenheiro integracao agentes salesforce",
        ...
        "forward deployed engineer fde ai agents",
        "forward deployed ai agent engineer",
        "engenheiro forward deployed agentes ia martech",
        "forward deployed engineer revops ia conversacional",
        "engenheiro implantacao agentes ia",
        ...
        "consultor tecnico implantacao ia",
        "engenheiro solucoes ia conversacional jornadas",
        "engenheiro integracao agentes ia salesforce hubspot whatsapp",
        "ai orchestration integration engineer",
        "especialista integracao llms tools conectores",
        "engenheiro automacao workflows agentes autonomos",
        "ai martech agent ops specialist",
...
BLACKLIST_VENDAS = {"vendas", "vendedor", "consultor de vendas", "gerente de vendas", "coordenador de vendas", "supervisor de vendas", "executivo de vendas", "promotor de vendas", "auxiliar de vendas", "assistente de vendas", "representante de vendas", "agente de vendas", "telemarketing", "operador de telemarketing", "telefonista", "recepcionista", "office boy", "almoxarife", "motorista", "entregador", "operador de caixa", "balconista", "atendente de loja", "gerente de loja", "supervisor de loja", "retail", "comércio"}

...
KEYWORDS = {
    ...
    "crm": [
        "crm", "analista de crm", "analista crm",
        ...
        "analista de campanhas", "lifecycle marketing",
        "growth crm", "crm growth",
        "implementacao crm", "implementação crm",
        "analista funcional crm", "consultor funcional crm",
        "crm developer", "desenvolvedor crm", "engenheiro crm",
        "salesforce", "salesforce administrator", "salesforce admin",
        ...
        "hubspot", "analista de hubspot", "analista hubspot",
        "especialista hubspot", "consultor hubspot",
        "hubspot administrator", "hubspot developer",
        "rd station", "analista de rd station", "especialista rd station",
        "consultor rd station",
        "dynamics crm", "microsoft dynamics crm",
        "pipedrive", "zoho crm", "activecampaign", "active campaign",
        "braze", "insider crm", "dinamize", "klaviyo", "oracle responsys",
        "loyalty crm", "fidelizacao crm", "fidelização crm",

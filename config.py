...
KEYWORDS = {
    ...
    "crm": [
        # Cargos CRM — "crm" standalone pega "Analista de Sistemas CRM" etc.
        "analista de crm", "analista crm", "analista sistemas crm", "sistemas crm",
        ...
        "implementação crm", "implementacao crm", "implantação crm", "implantacao crm",
        "analista de implementação crm", "crm implementation",
        # CRM + Marketing
        "crm marketing", "analista de crm marketing", "marketing de crm",
        "lifecycle marketing", "marketing de relacionamento",
        "analista de relacionamento crm", "crm e relacionamento",
        "email marketing crm", "marketing automation", "automação de marketing",
        "automacao de marketing", "martech",
        # CRM + Growth
        "growth crm", "crm growth", "growth marketing", "growth analyst",
        "analista de growth", "especialista em growth", "growth specialist",
        # CRM + Dev
        "desenvolvedor crm", "dev crm", "crm developer", "engenheiro crm",
        # CRM + Copy / Conteúdo
        "copywriter crm", "copy crm", "redator crm", "content crm",
        # Salesforce — antes de "dev" no dict para ter precedência
        "salesforce administrator", "salesforce admin",
        "salesforce developer", "salesforce developer & administrator",
        "salesforce consultant", "salesforce business analyst",
        "analista salesforce", "analista de salesforce",
        "analista funcional salesforce", "desenvolvedor salesforce",
        "salesforce", "marketing cloud", "sales cloud", "service cloud",
        # HubSpot
        "analista de hubspot", "hubspot specialist", "hubspot consultant",
        "hubspot administrator", "hubspot",
        # Outros CRMs
        "dynamics crm", "microsoft dynamics crm",
        "analista de rd station", "especialista rd station", "rd station",
        "pipedrive", "zoho crm", "active campaign", "activecampaign",
